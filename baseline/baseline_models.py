...
def qwen_vl(): # qwen_vl 함수 정의
    ...
    model_name = "Qwen/Qwen2.5-VL-7B-Instruct" # for testing
...
def llama_vision(): # llama_vision 함수 정의
    ...
    model_name = "meta-llama/Llama-3.2-1B-Vision-Instruct" # for testing
...
def gemma(): # gemma 함수 정의
    ...
    model_name = "google/gemma-3-4b-it" # for testing
