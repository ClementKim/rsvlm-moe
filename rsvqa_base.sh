...
# Qwen VL 3B
python3 baseline/baseline_main.py --model qwen --param 3 --batch $BATCH --seed $SEED --dataset rsvqa --train False --val False --test True --eval False 2> results/qwen_3_err
rm -rf ~/.cache/huggingface/hub/*

# Qwen VL 7B
python3 baseline/baseline_main.py --model qwen --param 7 --batch $BATCH --seed $SEED --dataset rsvqa --train False --val False --test True --eval False 2> results/qwen_7_err
rm -rf ~/.cache/huggingface/hub/*
...
# python3 baseline/baseline_main.py --model llama --param 11 --batch $BATCH --seed $SEED --dataset rsvqa --train False --val False --test True --eval False 2> results/llama_11_err
# rm -rf ~/.cache/huggingface/hub/*

# python3 baseline/baseline_main.py --model llama --param 90 --batch $BATCH --seed $SEED --dataset rsvqa --train False --val False --test True --eval False 2> results/llama_90_err
# rm -rf ~/.cache/huggingface/hub/*
...
# Gemma 4B
python3 baseline/baseline_main.py --model gemma --param 4 --batch $BATCH --seed $SEED --dataset rsvqa --train False --val False --test True --eval False 2> results/gemma_4_err
rm -rf ~/.cache/huggingface/hub/*

# Gemma 12B
python3 baseline/baseline_main.py --model gemma --param 12 --batch $BATCH --seed $SEED --dataset rsvqa --train False --val False --test True --eval False 2> results/gemma_12_err
rm -rf ~/.cache/huggingface/hub/*

# Gemma 27B
# python3 baseline/baseline_main.py --model gemma --param 27 --batch $BATCH --seed $SEED --dataset rsvqa --train False --val False --test True --eval False 2> results/gemma_27_err
# rm -rf ~/.cache/huggingface/hub/*
...
python3 baseline/baseline_main.py --model blip2 --param 0 --batch $BATCH --seed $SEED --dataset rsvqa --train False --val False --test True --eval False 2> results/blip2_err
rm -rf ~/.cache/huggingface/hub/*
